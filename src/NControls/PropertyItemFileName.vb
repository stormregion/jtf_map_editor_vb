...
Namespace NControls
	Public Class PropertyItemFileName
		Inherits PropertyItem

		Protected EditControl As NFilePickerTextBox

		Protected FileType As Integer
		...
		Public Sub New(filetype As Integer)
			Try
		...
		Public Overrides Sub UpdateControl(bounds As Rectangle)
			...
			Else
				Dim nFilePickerTextBox As NFilePickerTextBox = New NFilePickerTextBox(Me.Host.ObjType, Me.FileType)
				Me.EditControl = nFilePickerTextBox
		...
		Boolean
			Dim editControl As NFilePickerTextBox = Me.EditControl
